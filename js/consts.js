...
aboutMe.add_line("I enjoy programming, playing percussion in the Chugiak-");
aboutMe.add_line("Eagle River Community Band and mountain biking with friends.<br>");
aboutMe.add_line("Feel free to explore my website, I had fun making it! 😊");

aboutMe.add_line("<pre>                                                              </pre>");
aboutMe.setNumLines(17);
...
experience.add_line("<table><tr><td class=\"experienceLogo\"><img src=\"../images/taku-logo.jpg\" width=150 alt=\"taku engineering logo\"></td><td class=\"experienceText\"><h3>CP/CIS Intern</h3><div>> Taku Engineering, LLC (5/30/23-8/21/23)<br><br>Drafted demolition design drawings, helped<br>perform STI tank inspections on the North Slope,<br>and assisted with a 3-week CP and CIS survey.</div></td></tr></table>")
...
trim.add_line("We have already developed a successful prototype, and are in the");
...
aboutTheClub.add_line("passionate individuals interested in STEM and robotics in");
aboutTheClub.add_line("particular. The team consists of a range of majors, from");
aboutTheClub.add_line("Computer Science to Mechanical Engineering, though we do not");
aboutTheClub.add_line("require one to be a STEM major to join.<br>");
